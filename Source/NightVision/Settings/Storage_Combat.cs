...
public class Storage_Combat
{
    ...
    {
        CombatFeaturesEnabled = new SettingOption<bool>(Str_CombatSettings.CombatEnabled, true);
        ...
        MeleeHitEffectsEnabled = new SettingOption_WithPatch(
            ...
            [HarmonyPatchType.Postfix, HarmonyPatchType.Postfix],
            [
