// Nightvision SettingsHelpers.cs
// 
// 03 08 2018
// 
// 16 10 2018
...
public static class SettingsHelpers
{
    ...
    )
    {
        ...
        if (isRace)
        {
            ...
            {
                min = cache.MinCache.GetValueOrDefault();
                max = cache.MaxCache.GetValueOrDefault();
            }
        ...
        else
        {
            ...
            zeroModAsPercent = Widgets.HorizontalSlider(
                topRect,
                zeroModAsPercent,
                cache.MinCache.GetValueOrDefault() - 80,
                cache.MaxCache.GetValueOrDefault() - 80,
                true,
            ...
            fullModAsPercent = Widgets.HorizontalSlider(
                bottomRect,
                fullModAsPercent,
                cache.MinCache.GetValueOrDefault() - 100,
                cache.MaxCache.GetValueOrDefault() - 100,
                true,
