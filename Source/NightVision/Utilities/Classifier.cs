...
public static class Classifier
{
    ...
    )
    {
        ...
        if (isZeroLightMod)
        {
            ...
            return modifier + Constants.NV_EPSILON < ZeroLightTurningPoints[1]
                ? VisionType.NVNightVision
    ...
    )
    {
        ...
        var offsetIndex = forZeroLight ? 0 : 1;
        ...
        {
            result = [(float)Math.Round(result[0] / 2, Constants.NUMBER_OF_DIGITS)];
        }
