// Nightvision Race_LightModifiers.cs
// 
// 03 08 2018
// 
// 16 10 2018
...
public class Race_LightModifiers : LightModifiersBase
{
    ...
    {
        if (_parentDef.GetCompProperties<CompProperties_NightVision>() is { } compProps)
        {
            ...
            Offsets =
            [
                _nvCompProps.ZeroLightMultiplier - Constants.DEFAULT_ZERO_LIGHT_MULTIPLIER,
                _nvCompProps.FullLightMultiplier - Constants.DEFAULT_FULL_LIGHT_MULTIPLIER
            ];
